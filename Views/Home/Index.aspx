				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8">
							<ul>
								<li>Відсутність штрафних санкцій за перевищення величин потужності споживання електричної
									енергії</li>
							</ul>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8">
							<ul>
								<li>Відсутність штрафних санкцій за перевищення заявленого обсягу електричної енергії</li>
							</ul>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8">
							<ul>
								<li>Можливість коригування обсягів заявленої електричної енергії протягом розрахункового
									місяця</li>
							</ul>
						</div>
					</div>
					...
					<div class="icon-box wow slideInLeft">
						...
						<div class="box-body">
							<p>
								...
								на електричну енергію, що відпускається для кожного класу споживачів, крім населення,
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-offset-2 col-sm-6">
						...
						<address>
							79058, м. Львів, вул.Замарстинівська 83-а
							<br />
							...
							<p>
								E-mail:<a href="mailto:etzahid1@gmail.com">
									etzahid1@gmail.com</a>&nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;<a href="mailto:etzahid@ukr.net">etzahid@ukr.net</a>
							</p>
