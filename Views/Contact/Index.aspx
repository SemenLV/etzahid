...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
		...
		<div class="col-xs-12 col-sm-6">
			<div class="contactAdress">
				<h3>
					Адреса</h3>
				<address>
					<i class="icons-marker fa fa-home"></i>79058 Львівська область, м. Львів, вул.Замарстинівська
					83-а<br />
					<br />
				</address>
				<h3>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6">
			<div class="contactAdress">
				...
				Etzahid1@gmail.com
				<br /><br />
				Адреса: Львівська область, м. Львів, вул.Замарстинівська 83-а
				<br /><br />
				Режим/графік роботи:
				<br /><br />
				Понеділок – п’ятниця:
				...
				Закінчення роботи – 17 год 00 хв, в п’ятницю – 16 год 00 хв.
				<br /><br />
				Функції начальника Інформаційно консультаційного центру виконує директор ПП «Енерготрансзахід».
			</div>
		</div>
			...
			<div class="contactForm">
				...
				<div class="form-group">
					<div class="pull-left">
						...
						<br />
						<input type="text" name="captcha" maxlength="6" style="width: 120px; display: inline-block;"
	...
	<div class="row" style="padding-bottom:60px;">
		<div class="col-xs-12">
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2572.165968315239!2d24.02470571508423!3d49.858126937748075!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x473add07ed0273d1%3A0x63693b29c1634c0e!2z0LLRg9C70LjRhtGPINCX0LDQvNCw0YDRgdGC0LjQvdGW0LLRgdGM0LrQsCwgODMsINCb0YzQstGW0LIsINCb0YzQstGW0LLRgdGM0LrQsCDQvtCx0LvQsNGB0YLRjA!5e0!3m2!1suk!2sua!4v1500417574723"
		...
		<div class="col-xs-12">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-4">
					...
					<br />
					<a href="http://mpe.kmu.gov.ua/" target="_blank" title="Міністерство енергетики та вугільної промисловості України (Міненерговугілля)">
