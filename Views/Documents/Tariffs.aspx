				...
				<div class="panel panel-default">
					...
					<div id="collapse2021" class="panel-collapse collapse in">
						<div class="panel-body">
							...
							<br />
							<br />
							<div id="averagePrices">
								Середньозважені ціни на Ринку доба наперед
								<ul>
									<li> Січень – 3 466,83 грн/МВт без ПДВ</li>
									<li> Лютий – 3 213,43 грн/МВт без ПДВ </li>
								</ul>
							</div>
							<br />
							<br />
				...
				<div class="panel panel-default">
					...
					<div id="collapse2021" class="panel-collapse collapse in">
						<div class="panel-body">
							...
							<br />
							<br />
							<a href="https://www.oree.com.ua/index.php/web/128" title="Аналітична інформація щодо середньозважених цін ДП 'Оператор ринку'"
								target="_blank">
								Аналітична інформація щодо середньозважених цін ДП "Оператор ринку"</a>
						</div>
					</div>
				</div>
				<div class="panel panel-default">
