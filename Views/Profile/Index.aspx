		...
		<div class="row" style="margin-bottom:30px;">
			<div class="col-xs-12">
				...
				<ol>
					...
					<li>умови в т.ч. строк, протягом якого споживач має попередньо проінформувати свого
				...
				<form id="frmRegister" action="<%=Url.Action(" Index", "Profile" ) %>" method="post">
					...
					<div>
						<img id="imgCaptcha" alt="captcha" src="<%=Url.Action("GetImage", "Captcha" , new { w="200" ,
							h="50" })%>" />
						<br />
						<span>
